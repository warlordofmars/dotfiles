...
class RubyHelper {
    ...
    static getRubyEnvFromPuppetAgent(rubyFile, connectionConfiguration, logger) {
        let logPrefix = '[getRubyExecFromPuppetAgent] ';
        // setup defaults
        let spawn_options = {};
    ...
    static getRubyEnvFromPDK(rubyFile, connectionConfiguration, logger) {
        let logPrefix = '[getRubyEnvFromPDK] ';
        // setup defaults
        let spawn_options = {};
        spawn_options.env = process.env;
        let result = {
        ...
        let pdkDir = connectionConfiguration.pdkDir;
        switch (process.platform) {
            case 'win32':
                result.options.stdio = 'pipe';
                break;
